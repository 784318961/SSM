...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/statics/js/addUser.js"></script>
<%-- <script type="text/javascript" src="${pageContext.request.contextPath }/statics/calendar/WdatePicker.js"></script> --%>
<body>
	<div>
		<form
			action="${pageContext.request.contextPath}/user/sys/addSave.html"
			method="post" enctype="multipart/form-data">

			<input type="hidden" id="path"
				value="${pageContext.request.contextPath}" />
			<p>
				用户编码: <input type="text" name="userCode" id="userCode" /> <font id="font"></font>
			...
			<p>
				...
				男 <input type="radio" name="gender" value="2" /> 女
			</p>
			<p>
				出生日期: 
